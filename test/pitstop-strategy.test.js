...
describe('Pitstop Strategy', function () {
  ...
  it('should calculate expected race time with no pitstops', function () {
    var fc = new $ByLap.createRace(fuelTankAttributes, raceParameters);
  ...
  it('Regression Test #1', function () {
    ...
    var fc = new $ByLap.createRace({maximumFuel: 20, minimumFuel:4, consumption: 4}, raceParameters, undefined, pitStopHandler);
    var raceResult = fc.startRace();
